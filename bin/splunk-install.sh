...
sleep 180
TOKEN=$(docker exec -it splunk /opt/splunk/bin/splunk http-event-collector create -uri https://localhost:8089 -name general -auth admin:Password123 | tail -n 11 | head -n 1 | cut -f2 -d"=" | tr -cd "[:print:]\n")
